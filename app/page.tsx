  ...
  return (
    ...
    >
      ...
      <Link href="/stories" style={{ textDecoration: 'none', flexShrink: 0 }}>
        <div style={{ margin: '6px 16px 0', padding: '10px 14px', borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
