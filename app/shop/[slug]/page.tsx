...
import { ChevronLeft, ShoppingCart, Star, Package } from 'lucide-react'
    ...
    <div style={{ backgroundColor: '#08090D', minHeight: '100dvh', paddingBottom: 120 }}>
      ...
      <div className="relative" style={{ height: 320, backgroundColor: '#0e0910' }}>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, rgba(8,9,13,0.1) 0%, rgba(8,9,13,1) 100%)' }}
        />
      </div>
      ...
      <div className="px-5" style={{ marginTop: -24 }}>
        ...
        {product.variants.length > 0 && (
          <div className="mb-8">
            <p className="text-[10px] font-medium uppercase tracking-widest mb-3" style={{ color: 'rgba(255,255,255,0.2)' }}>
              Options
            </p>
        ...
        {product.reviews.length > 0 && (
          <div>
            <p className="text-[10px] font-medium uppercase tracking-widest mb-4" style={{ color: 'rgba(255,255,255,0.2)' }}>
              Reviews
            </p>
            <div className="flex flex-col gap-3">
              {product.reviews.slice(0, 5).map((review) => (
                ...
                >
                    ...
                    <div className="flex gap-0.5">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <Star
                          key={i}
                          size={9}
                          fill={i < review.rating ? '#A66A86' : 'transparent'}
                          color={i < review.rating ? '#A66A86' : 'rgba(255,255,255,0.15)'}
                        />
                      ))}
                    </div>
                  ...
                  {review.title && (
                    <p className="text-[12px] font-medium text-white/70 mb-1">{review.title}</p>
                  )}
